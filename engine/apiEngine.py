...
def CustomNotification():
        ...
        try:
                if(request.method == 'POST'):
                        ...
                        key = redis_access_key()[2]+str(request.data)
                        #-.read cache.
                        message = _read_redis_cache_api(key,rd)
...
def GenerateCustomerPortfolio():
        ...
        try:
                if(request.method == 'POST'):
                        ...
                        key = redis_access_key()[1]+str(msisdn)
        ...
        try:
                if(request.method == 'GET'):
                        ...
                        if(request.data):
                                ...
                                _delete_from_redis_cache_api(r_key,r_db)
                                #-.write key & message to redis.        
                                _save_to_redis_cache_api(r_key,r_msg,r_db)
